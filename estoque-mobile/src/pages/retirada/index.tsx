...
export default function HomeScreen() {
  ...
  const handleProjectPress = (project) => {
    navigation.navigate("Escolher Peças Para Retirada", { cod_projeto: project.cod_projeto });
  };
  ...
  const handleSubProjectPress = (subProject) => {
    ...
    navigation.navigate("Escolher Peças Para Retirada", { cod_projeto: subProject.cod_projeto });
  };
